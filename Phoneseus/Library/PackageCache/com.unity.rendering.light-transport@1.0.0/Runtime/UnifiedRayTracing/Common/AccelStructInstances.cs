...
{
    internal class AccelStructInstances
    {
        ...
        {
            shader.SetBufferParam(cmd, Shader.PropertyToID(name + "instanceList"), m_InstanceBuffer.GetGpuBuffer());
            ...
            shader.SetIntParam(cmd, Shader.PropertyToID("g_globalVertexBufferStride"), m_GeometryPool.globalVertexBufferSrideBytes/4);
