...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    ...
    internal class GeometryPool : IDisposable
    {
        ...
        private static class GeoPoolShaderIDs
        {
            ...
            public static readonly int _InputIBOffset = Shader.PropertyToID("_InputIBOffset");
            ...
            GraphicsBuffer outputIdxBuffer)
        {
            ...
            cmdBuffer.SetComputeIntParam(m_GeometryPoolKernelsCS, GeoPoolShaderIDs._InputIBOffset, inputOffset);
            ...
            int groupCountsX = DivUp(location.block.count, kThreadGroupSize);
