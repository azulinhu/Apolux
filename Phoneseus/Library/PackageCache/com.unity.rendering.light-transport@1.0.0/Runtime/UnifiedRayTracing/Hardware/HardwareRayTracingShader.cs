...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    internal class HardwareRayTracingShader : IRayTracingShader
    {
        ...
        internal HardwareRayTracingShader(string shaderFilename, string dispatchFuncName, Func<string, Type, Object> shaderFileLoader)
        {
            m_Shader = (RayTracingShader) shaderFileLoader(shaderFilename+".raytrace", typeof(RayTracingShader));
